...
public class MySite_HelloWorldController : WAF.Server.Controllers.ContentController<WAF.API.MySite.HelloWorld> { 
public MySite_HelloWorldController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
