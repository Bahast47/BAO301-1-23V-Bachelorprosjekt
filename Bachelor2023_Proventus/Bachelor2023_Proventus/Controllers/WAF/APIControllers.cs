...
public class MySite_CourseController : WAF.Server.Controllers.ContentController<WAF.API.MySite.Course> { 
public MySite_CourseController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class MySite_InstructorController : WAF.Server.Controllers.ContentController<WAF.API.MySite.Instructor> { 
public MySite_InstructorController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class MySite_ParticipantController : WAF.Server.Controllers.ContentController<WAF.API.MySite.Participant> { 
public MySite_ParticipantController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class MySite_VenueController : WAF.Server.Controllers.ContentController<WAF.API.MySite.Venue> { 
public MySite_VenueController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
...
public class MySite_ConatctUsController : WAF.Server.Controllers.ContentController<WAF.API.MySite.ConatctUs> { 
public MySite_ConatctUsController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
