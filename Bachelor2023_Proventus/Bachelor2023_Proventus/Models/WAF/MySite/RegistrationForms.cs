...
namespace WAF.Engine.Content.MySite {
    [Serializable]
    public partial class RegistrationForms: WAF.Engine.Content.Native.HierarchicalContent {
        ...
        NodeRelationsPropertyValue<WAF.Engine.Content.MySite.Course> _course;
        public virtual NodeRelationsPropertyValue<WAF.Engine.Content.MySite.Course> Course{
        get {EnsureContentDataIndependence(); return NodeRelationsPropertyValue<WAF.Engine.Content.MySite.Course>.GetValue(WAFID.GetDataValueId("11935030-00c9-43d8-a2eb-ac0c97cdad6d"), ref _course, this);}
        }
      
        public override IContent AddCulture(int lcid) {
            return _WAFSession.AddCulture<RegistrationForms>(NodeId, lcid);
        }
        public override IContent AddRevision(int revision) {
            return _WAFSession.AddRevision<RegistrationForms>(NodeId, revision);
        }
        public override IContent AddContent(int lcid, int revision) {
            return _WAFSession.AddContent<RegistrationForms>(NodeId, lcid, revision);
        }
        ///<summary>
        ...
        public static int PropertyIdCourse {
            get {
                return WAFID.GetPropertyId("11935030-00c9-43d8-a2eb-ac0c97cdad6d");
            }
        }
        ...
        public override object GetProperty(int propertyId) {
            ...
            else if (propertyId == WAFID.GetPropertyId("11935030-00c9-43d8-a2eb-ac0c97cdad6d")) {
                object init = Course;
                return _course;
            }
...
namespace WAF.Data.Query.MySite {
    public abstract class SqlRegistrationForms {
        public static SqlTable Table {
            get {
                return new SqlTable("registration_forms", WAFID.GetContentClassId("ba72d9fc-6643-402c-a125-f3b08362fb75"));
            }
        }
    ...
    public class SqlAliasRegistrationForms : SqlAlias {
        public SqlAliasRegistrationForms()
            : base(SqlRegistrationForms.Table) {
        }
        public SqlExpressionFieldInteger ContentId {
            get {
                return new SqlExpressionFieldInteger(SqlRegistrationForms.Field.ContentId, this);
            }
        }

        public SqlExpressionFieldLongString FormContainer {
            get {
                return new SqlExpressionFieldLongString(SqlRegistrationForms.Field.FormContainer, this);
            }
        }

        public SqlExpressionFieldLongString SignUp {
            get {
                return new SqlExpressionFieldLongString(SqlRegistrationForms.Field.SignUp, this);
            }
        }
...
namespace WAF.Engine.Query.MySite {
    [System.Serializable]
    public partial class AqlRegistrationForms{
        ...
        public static AqlPropertyLongString FormContainer {
            get {
                return new AqlPropertyLongString(WAF.Data.Query.MySite.SqlRegistrationForms.Field.FormContainer, WAFID.GetContentClassId("ba72d9fc-6643-402c-a125-f3b08362fb75"));
            }
        }

        public static AqlPropertyLongString SignUp {
            get {
                return new AqlPropertyLongString(WAF.Data.Query.MySite.SqlRegistrationForms.Field.SignUp, WAFID.GetContentClassId("ba72d9fc-6643-402c-a125-f3b08362fb75"));
            }
        }

        public static AqlPropertyRelation Course {
            get {
                return new AqlPropertyRelation( WAFID.GetPropertyId("11935030-00c9-43d8-a2eb-ac0c97cdad6d"), new AqlAliasRelation(new WAF.Engine.Query.MySite.AqlAliasCourse(), new WAF.Engine.Query.MySite.AqlAliasRegistrationForms(), WAF.Engine.Query.MySite.AqlRelCoursesRegistrationForms.Relation));
            }
        }
    ...
    [System.Serializable]
    public class AqlAliasRegistrationForms
        : WAF.Engine.Query.Native.AqlAliasHierarchicalContent{

        public AqlAliasRegistrationForms()
            : base(WAFID.GetContentClassId("ba72d9fc-6643-402c-a125-f3b08362fb75")) {

        }

        public AqlAliasRegistrationForms(int contentClassId)
            : base(contentClassId) {
        ...
        public AqlExpressionPropertyLongString FormContainer {
            get {
                return new AqlExpressionPropertyLongString(AqlRegistrationForms.FormContainer, this);
            }
        }

        public AqlExpressionPropertyLongString SignUp {
            get {
                return new AqlExpressionPropertyLongString(AqlRegistrationForms.SignUp, this);
            }
        }
