...
: base(dataProvider) {}
        ...
        static Guid _locationGuid = new Guid("c1f7b8c3-f10a-4ee2-a76f-a3f05b408f5d");
        [PropertyGuid("c1f7b8c3-f10a-4ee2-a76f-a3f05b408f5d")]
...
: base(dataProvider) {}
        ...
        static Guid _isPublicGuid = new Guid("929a46d6-b5a0-479c-9056-55d14a02a8ac");
        [PropertyGuid("929a46d6-b5a0-479c-9056-55d14a02a8ac")]
        public bool IsPublic {
        get { return (bool)DataProvider.GetPropertyValue(_isPublicGuid); }
        set { DataProvider.SetPropertyValue(_isPublicGuid, value); }
        }
...
: base(dataProvider) {}
        ...
        static Guid _adressGuid = new Guid("fd1ce14d-a6e2-4902-bb91-514d1a39e6ac");
        [PropertyGuid("fd1ce14d-a6e2-4902-bb91-514d1a39e6ac")]
        public string Adress {
        get { return (string)DataProvider.GetPropertyValue(_adressGuid); }
        set { DataProvider.SetPropertyValue(_adressGuid, value); }
        }
