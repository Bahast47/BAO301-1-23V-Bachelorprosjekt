...
namespace WAF.Engine.Content.MySite {
    ...
    public partial class Course: WAF.Engine.Content.Native.HierarchicalContent {
        ...
        LinkPropertyValue _location;
        public virtual LinkPropertyValue Location {
        get {  EnsureContentDataIndependence(); return LinkPropertyValue.GetValue(WAFID.GetDataValueId("910bdfc4-4e68-49ef-b0e5-bec6edd4867f"), ref _location, this.Session, this.ContentId, this.ContentData.DataValueById, this.ContentParentPath); }
        }
        ...
        public static int PropertyIdLocation {
            get {
                return WAFID.GetPropertyId("c1f7b8c3-f10a-4ee2-a76f-a3f05b408f5d");
            }
        }

        public static int DataValueIdLocationLocation {
            get {
                return WAFID.GetDataValueId("910bdfc4-4e68-49ef-b0e5-bec6edd4867f");
            }
        }
        ...
        public override object GetProperty(int propertyId) {
            ...
            else if (propertyId == WAFID.GetPropertyId("c1f7b8c3-f10a-4ee2-a76f-a3f05b408f5d")) {
...
namespace WAF.Data.Query.MySite {
    public abstract class SqlCourse {
        ...
        public abstract partial class Field {
            ...
            public static SqlFieldShortString Location {
                get {
                    return new SqlFieldShortString("location", Table, WAFID.GetDataValueId("910bdfc4-4e68-49ef-b0e5-bec6edd4867f"));
                }
            }
    ...
    public class SqlAliasCourse : SqlAlias {
        ...
        public SqlExpressionFieldShortString Location {
            get {
                return new SqlExpressionFieldShortString(SqlCourse.Field.Location, this);
            }
        }
...
namespace WAF.Engine.Query.MySite {
    ...
    public partial class AqlCourse{
        ...
        public static AqlPropertyShortString Location {
            get {
                return new AqlPropertyShortString(WAF.Data.Query.MySite.SqlCourse.Field.Location, WAFID.GetContentClassId("fdb92bac-b379-43ec-b327-02cc014b0ac5"));
            }
        }
    ...
    public class AqlAliasCourse
        ...
        public AqlExpressionPropertyShortString Location {
            get {
                return new AqlExpressionPropertyShortString(AqlCourse.Location, this);
            }
        }
